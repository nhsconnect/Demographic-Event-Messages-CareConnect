...
PDS Change of Address event messages are generated by the Spine and published to the NEMS when the address of a patient is changed within their PDS record. The event message will contains the patients new address and their previous address as per the guidance below.
